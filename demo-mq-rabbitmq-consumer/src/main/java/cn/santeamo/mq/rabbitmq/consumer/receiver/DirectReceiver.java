...
public class DirectReceiver {
    ...
    @RabbitListener(containerFactory = RabbitConst.Default.RABBIT_LISTENER_CONTAINER, queues = RabbitConst.Direct.QUEUE)
    @RabbitHandler
    public void directMsgReceiver(String msg, Message message, Channel channel) {
        long deliveryTag = message.getMessageProperties().getDeliveryTag();
        try {
            log.info("[virtual-host = {}] [queue = {}] 收到消息 {} ", RabbitConst.Default.VIRTUAL_HOST, RabbitConst.Direct.QUEUE, msg);
    ...
    public void directMsgReceiverNew(String msg) {
        log.info("[virtual-host = {}] [queue = {}] New 收到消息 {} ", RabbitConst.Default.VIRTUAL_HOST, RabbitConst.Direct.QUEUE, msg);
    }
}
